...
"}")
        ...
        self.updateMenuButton = QAction(MainWindow)
        self.updateMenuButton.setObjectName(u"updateMenuButton")
...
"}")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/in-order-icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.wordPermutationsCheckbox.setIcon(icon1)
...
"")
        ...
        icon2 = QIcon()
        icon2.addFile(u":/filter-icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/clear-filter-icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.clearFilterButton.setIcon(icon3)
...
"")
        ...
        icon6 = QIcon()
        icon6.addFile(u":/chatgpt-icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.menuChatGPT.setIcon(icon6)
        ...
        self.helpMenuButton.addAction(self.updateMenuButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.updateMenuButton.setText(QCoreApplication.translate("MainWindow", u"\u062a\u062d\u062f\u064a\u062b", None))
#if QT_CONFIG(tooltip)
